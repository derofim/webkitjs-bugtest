...
// Without this we'll get plenty of conversion warnings due to cairo's
// implementation of enums and use of varying enum types per backend vs. frontend.
...
/* For some reason the config script says we have this, but we dont. #define HAVE___UINT128_T 1 */
